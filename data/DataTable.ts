...
const DataTableValues: DataTableInterface[] = [
    ...
    },
    {
        ...
        questions: [
            ...
            {
                idq: 2,
                str: 'نوع فعالیت ورزشی/تمرین(شامل لیست کامل انواع ورزشهای تیمی و انفرادی)',
                values: null
            },
            {
                idq: 3,
    ...
    },
    {
        ...
        questions: [
            ...
            {
                idq: 2,
                str: 'ضربه یا تصادف با اشیا، انسان یا حیوان (تماس با جسم یا شخص متحرک و ساکن)',
                values: null
            },
            {
                idq: 3,
            ...
            {
                idq: 6,
                str: 'اعمال بیش از حد حاد بدن یا بخشی از بدن (شامل لیستی از تغییر ناگهانی سرعت، تغییر جهت شامل چرخش، پیچش و ...)',
                values: null
            },
